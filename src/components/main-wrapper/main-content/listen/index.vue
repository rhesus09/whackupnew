      ...
      <section class="vbox animated fadeInUp">
        <section class="scrollable">
          <div class="m-t-n-xxs item pos-rlt">
            ...
            <img class="img-full" :src="getItemPerGenre[this.$route.params.id].photo" alt="...">
          </div>
          ...
          <ul class="list-group list-group-lg no-bg auto m-b-none m-t-n-xxs">
            <li class="list-group-item clearfix">
              ...
              <a href="#" class="pull-left thumb-sm m-r">
                <img :src="getItemPerGenre[this.$route.params.id].photo" alt="...">
              </a>
              <a class="clear" href="#">
  ...
  export default {
    computed: {
      ...
      getItem () {
        ...
        return _.filter(this.getItemPerGenre, _.matches({'idClub': 0}))
      }
    },
    data () {
      return {testqdfq: this.$route.params.id}
    },
    methods: {
