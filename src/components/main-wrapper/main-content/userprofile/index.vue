                  ...
                  <div class="wrapper">
                    <div class="text-center m-b m-t">
                      <a href="#" class="thumb-lg">
                        <img src="../../../../../images/user-512.png" class="img-circle">
                      </a>
                      <div>
                        <div class="h3 m-t-xs m-b-xs"> {{this.getCurrentUserName}} {{this.getCurrentUserPrenom}} </div>
                        <small class="text-muted"><i class="fa fa-map-marker"></i> Paris, France</small>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi id neque quam. Aliquam sollicitudin venenatis ipsum ac feugiat.</p>
                      <div class="line"></div>
            ...
            <aside class="col-lg-3 b-l">
              <section class="vbox">
                <section class="scrollable padder-v">
                  <div class="panel">
                    <h4 class="font-thin padder">Tweets Recents</h4>
                    <ul class="list-group">
                      <li class="list-group-item">
                      ...
                      <li class="list-group-item">
                        <p>Morbi nec <a href="#" class="text-info">@Jonathan George</a>
                          nunc condimentum ipsum dolor sit amet, consectetur</p>
                        <small class="block text-muted"><i class="fa fa-clock-o"></i> 1 hour ago</small>
                      </li>
                      <li class="list-group-item">
                        <p><a href="#" class="text-info">@Josh Long</a>
...
<script>
  ...
  export default{
    computed: {
      ...mapGetters({
        getCurrentUserName: types.GET_CURRENT_LOGGED_USER_NAME,
        getCurrentUserPrenom: types.GET_CURRENT_LOGGED_USER_PRENOM
      })
    }
  }
</script>
